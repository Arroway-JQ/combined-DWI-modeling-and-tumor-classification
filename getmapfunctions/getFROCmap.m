function [params,paramsmap] = getFROCmap(mainDir,patientname,x,y,z,A,normdecay,onormdecay,b,DDC_init,alpha)
...
%save([mainDir 'WholeFROC/' 'froc' patientname],'params','paramsmap');
fprintf('FROC done');
